  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ background: "rgba(10,132,255,0.12)", border: "1px solid rgba(10,132,255,0.3)", borderRadius: "99px", padding: "6px 20px", marginBottom: "24px", color: "#0a84ff", fontSize: "14px", fontWeight: 700, letterSpacing: "3px", textTransform: "uppercase" }}>Get in Touch</div>
        <h1 style={{ fontSize: "64px", fontWeight: 800, color: "#fdfdfd", textAlign: "center", lineHeight: 1.1, margin: 0, marginBottom: "18px", letterSpacing: "-1px" }}>
          Let&apos;s Talk About <span style={{ color: "#0a84ff" }}>Your Project</span>
        </h1>
        <p style={{ fontSize: "22px", color: "#8a94a3", textAlign: "center", margin: 0, maxWidth: "680px", lineHeight: 1.4 }}>
          From early idea to production — we&apos;re here to help you build something exceptional.
        </p>
