  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ background: "rgba(10,132,255,0.12)", border: "1px solid rgba(10,132,255,0.3)", borderRadius: "99px", padding: "6px 20px", marginBottom: "24px", color: "#0a84ff", fontSize: "14px", fontWeight: 700, letterSpacing: "3px", textTransform: "uppercase" }}>Partnerships</div>
